    ...
    <body onload="window.print()">
            <table class="print-table">
				...
				<tr>
					...
					<span class="auto-style3"><span class="auto-style3">Frame:<?php echo ($order["frame"]); ?></span>
					
					</span></span><br class="auto-style3">
					<span class="auto-style3"><span class="auto-style3">Lenses:<?php echo ($order["lenses"]); ?></span>
					
					</span></span><br><span class="auto-style5">Contact Lens</span><br><span class="auto-style3">Right Eye OD <?php echo getArabic('Right Eye OD')?></span><br class="auto-style3">
